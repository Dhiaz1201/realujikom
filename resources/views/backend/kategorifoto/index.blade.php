                                ...
                                <table>
                                  ...
                                  <td>{{ $no++ }}</td>
                                   <td>{{ $data->kategori_foto }}</td>
                                    <td>{{ $data->slug }}</td>
                                           <td>
                                            <button data-toggle="tooltip" title="Edit" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i><a href="{{ route('kategorifoto.edit', $data->id) }}"></button>
                                            </td>
                                            <td>
