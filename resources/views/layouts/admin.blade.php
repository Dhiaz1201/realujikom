...
<head>
    ...
    <link rel="stylesheet" href="/admin/assets/css/owl.theme.css">
    <link rel="stylesheet" href="/admin/assets/css/owl.transitions.css">
    <!-- animate CSS
		============================================ -->
    ...
    <!-- educate icon CSS
		============================================ -->
    <link rel="stylesheet" href="/admin/assets/css/educate-custon-icon.css">
    <!-- morrisjs CSS
		============================================ -->
    <link rel="stylesheet" href="/admin/assets/css/morrisjs/morris.css">
    <!-- mCustomScrollbar CSS
		============================================ -->
    <link rel="stylesheet" href="/admin/assets/css/scrollbar/jquery.mCustomScrollbar.min.css">
    <!-- metisMenu CSS
		============================================ -->
    <link rel="stylesheet" href="/admin/assets/css/metisMenu/metisMenu.min.css">
    <link rel="stylesheet" href="/admin/assets/css/metisMenu/metisMenu-vertical.css">
    <!-- calendar CSS
		============================================ -->
    <link rel="stylesheet" href="/admin/assets/css/calendar/fullcalendar.min.css">
    <link rel="stylesheet" href="/admin/assets/css/calendar/fullcalendar.print.min.css">
    <!-- style CSS
		============================================ -->
...
<body>
    ...
    <div class="left-sidebar-pro">
        <nav id="sidebar" class="">
            <div class="sidebar-header">
                ...
                <strong><a href="index.html"><img src="/admin/assets/img/logo/logosn.png" alt="" /></a></strong>
            </div>
                    ...
                    <ul class="metismenu" id="menu1">
                        <li class="active">
                            <a class="has-arrow" href="index.html">
								   ...
								   <span class="mini-click-non">Table</span>
								</a>
                            <ul class="submenu-angle" aria-expanded="true">
                                <li><a title="Dashboard v.1" href="{{url('home/fotostudio')}}"><span class="mini-sub-pro">Foto Studio</span></a></li>
                                <li><a title="Dashboard v.2" href="{{url('home/kategorifoto')}}"><span class="mini-sub-pro">Kategori Foto</span></a></li>
                                <li><a title="Dashboard v.3" href="{{url('home/gallery') }}"><span class="mini-sub-pro">Gallery</span></a></li>
                            </ul>
                        </li>
                        <li>
                            <a class="has-arrow" href="all-professors.html" aria-expanded="false"><span class="educate-icon educate-charts icon-wrap"></span> <span class="mini-click-non">Laporan</span></a>
                                            ...
                                            <ul class="nav navbar-nav mai-top-nav header-right-menu">
                                                    ...
                                                    <div role="menu" class="author-message-top dropdown-menu animated zoomIn">
                                                        ...
                                                        <ul class="message-menu">
                                                            <li>
                                                                <a href="#">
                                                                    <div class="message-img">
                                                                        <img src="/admin/assets/img/contact/1.jpg" alt="">
                                                                    </div>
                                                            ...
                                                            <li>
                                                                <a href="#">
                                                                    <div class="message-img">
                                                                        <img src="/admin/assets/img/contact/4.jpg" alt="">
                                                                    </div>
                                                                    <div class="message-content">
                                                                        <span class="message-date">16 Sept</span>
                                                                        <h2>Sulaiman din</h2>
                                                            ...
                                                            <li>
                                                                <a href="#">
                                                                    <div class="message-img">
                                                                        <img src="/admin/assets/img/contact/3.jpg" alt="">
                                                                    </div>
                                                                    <div class="message-content">
                                                                        <span class="message-date">16 Sept</span>
                                                                        <h2>Victor Jara</h2>
                                                            ...
                                                            <li>
                                                                <a href="#">
                                                                    <div class="message-img">
                                                                        <img src="/admin/assets/img/contact/2.jpg" alt="">
                                                                    </div>
                                                                    <div class="message-content">
                                                                        <span class="message-date">16 Sept</span>
                                                                        <h2>Victor Jara</h2>
                                                ...
                                                <li class="nav-item">
                                                    <a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle">
															<img src="/admin/assets/img/product/pro4.jpg" alt="" />
                                                    ...
                                                    <ul role="menu" class="dropdown-header-top author-log dropdown-menu animated zoomIn">
                                                     ...
                                                     document.getElementById('logout-form').submit();"><span class="edu-icon edu-settings author-log-ic"></span>
                                                    {{ __('Logout') }} </a>
                                                        </li>                
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                        <div class="single-cards-item">
                            <div class="single-product-image">
                                <a href="#"><img src="/admin/assets/img/product/profile-bg.jpg" alt=""></a>
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                        <div class="single-review-st-item res-mg-t-30 table-mg-t-pro-n">
                            ...
                            <div class="single-review-st-text">
                                <img src="/admin/assets/img/notification/1.jpg" alt="">
                            ...
                            <div class="single-review-st-text">
                                <img src="/admin/assets/img/notification/2.jpg" alt="">
                                <div class="review-ctn-hf">
                                    <h3>Garbease sha</h3>
                                    <p>Awesome Pro</p>
                                </div>
                            ...
                            <div class="single-review-st-text">
                                <img src="/admin/assets/img/notification/3.jpg" alt="">
                                <div class="review-ctn-hf">
                                    <h3>Gobetro pro</h3>
                                    <p>Great Website</p>
                                </div>
                            ...
                            <div class="single-review-st-text">
                                <img src="/admin/assets/img/notification/4.jpg" alt="">
                                <div class="review-ctn-hf">
                                    <h3>Siam Graves</h3>
                                    <p>That's Good</p>
                                </div>
                            ...
                            <div class="single-review-st-text">
                                <img src="/admin/assets/img/notification/5.jpg" alt="">
                                <div class="review-ctn-hf">
                                    <h3>Sarah Graves</h3>
                                    <p>Highly recommend</p>
                                </div>
                            ...
                            <div class="single-review-st-text">
                                <img src="/admin/assets/img/notification/6.jpg" alt="">
                                <div class="review-ctn-hf">
                                    <h3>Julsha Grav</h3>
                                    <p>Sei Hoise bro</p>
                                </div>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        <div class="single-product-item res-mg-t-30 table-mg-t-pro-n tb-sm-res-d-n dk-res-t-d-n">
                            <div class="single-product-image">
                                <a href="#"><img src="/admin/assets/img/product/book-4.jpg" alt=""></a>
                            </div>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        <div class="courses-inner res-mg-t-30 table-mg-t-pro-n tb-sm-res-d-n dk-res-t-d-n">
                            <div class="courses-title">
                                <a href="#"><img src="/admin/assets/img/courses/1.jpg" alt="" /></a>
    ...
    <!-- price-slider JS
		============================================ -->
    <script src="/admin/assets/js/jquery-price-slider.js"></script>
    <!-- meanmenu JS
		============================================ -->
    ...
    <!-- sticky JS
		============================================ -->
    <script src="/admin/assets/js/jquery.sticky.js"></script>
    <!-- scrollUp JS
		============================================ -->
    <script src="/admin/assets/js/jquery.scrollUp.min.js"></script>
    <!-- counterup JS
		============================================ -->
    <script src="/admin/assets/js/counterup/jquery.counterup.min.js"></script>
    <script src="/admin/assets/js/counterup/waypoints.min.js"></script>
    <script src="/admin/assets/js/counterup/counterup-active.js"></script>
    <!-- mCustomScrollbar JS
		============================================ -->
    <script src="/admin/assets/js/scrollbar/jquery.mCustomScrollbar.concat.min.js"></script>
    <script src="/admin/assets/js/scrollbar/mCustomScrollbar-active.js"></script>
    <!-- metisMenu JS
		============================================ -->
    <script src="/admin/assets/js/metisMenu/metisMenu.min.js"></script>
    <script src="/admin/assets/js/metisMenu/metisMenu-active.js"></script>
    <!-- morrisjs JS
		============================================ -->
    <script src="/admin/assets/js/morrisjs/raphael-min.js"></script>
    <script src="/admin/assets/js/morrisjs/morris.js"></script>
    <script src="/admin/assets/js/morrisjs/morris-active.js"></script>
    <!-- morrisjs JS
		============================================ -->
    <script src="/admin/assets/js/sparkline/jquery.sparkline.min.js"></script>
    <script src="/admin/assets/js/sparkline/jquery.charts-sparkline.js"></script>
    <script src="/admin/assets/js/sparkline/sparkline-active.js"></script>
    <!-- calendar JS
		============================================ -->
    <script src="/admin/assets/js/calendar/moment.min.js"></script>
    <script src="/admin/assets/js/calendar/fullcalendar.min.js"></script>
    <script src="/admin/assets/js/calendar/fullcalendar-active.js"></script>
    <!-- plugins JS
		============================================ -->
