				...
				<div class="photograhy">
					<div class="row no-gutters">
						<div class="col-md-4 ftco-animate">
							<a href="{{ url('indexfoto/paket/prewedding')}}" class="photography-entry img d-flex justify-content-center align-items-center" style="background-image: url(welcome/assets/images/image_1.jpg);">
								<div class="overlay"></div>
								<div class="text text-center">
									<h3>Paket 1</h3>
									<span class="tag" name="paketfoto" id="main_menu" value="prewedding">Prewedding</span>
									{{-- <option class="tag" name="paketfoto" id="main_menu" value="prewedding" onchange="populate(this.id,'paket')">Prewedding</option> --}}
								</div>
							</a>
						</div>
						<div class="col-md-4 ftco-animate">
							<a href="{{ url('indexfoto/paket/wedding')}}" class="photography-entry img d-flex justify-content-center align-items-center" style="background-image: url(welcome/assets/images/image_2.jpg);">
								<div class="overlay"></div>
								<div class="text text-center">
									<h3>Paket 2</h3>
									<span class="tag" name="paketfoto" id="main_menu" value="wedding">Wedding</span>
								</div>
							</a>
						</div>
						<div class="col-md-4 ftco-animate">
							<a href="{{ url('indexfoto/paket/personal')}}" class="photography-entry img  d-flex justify-content-center align-items-center" style="background-image: url(welcome/assets/images/image_3.jpg);">
								<div class="overlay"></div>
								<div class="text text-center">
									<h3>Paket 3</h3>
						...
						<div class="col-md-4 ftco-animate">
							<a href="{{ url('indexfoto/paket/duo')}}" class="photography-entry img  d-flex justify-content-center align-items-center" style="background-image: url(welcome/assets/images/image_4.jpg);">
								<div class="overlay"></div>
								<div class="text text-center">
									<h3>Paket 4</h3>
						...
						<div class="col-md-4 ftco-animate">
							<a href="{{ url('indexfoto/paket/group')}}" class="photography-entry img  d-flex justify-content-center align-items-center" style="background-image: url(welcome/assets/images/image_5.jpg);">
								<div class="overlay"></div>
								<div class="text text-center">
									<h3>Paket 5</h3>
						...
						<div class="col-md-4 ftco-animate">
							<a href="{{ url('indexfoto/paket/pasphoto')}}" class="photography-entry img  d-flex justify-content-center align-items-center" style="background-image: url(welcome/assets/images/image_6.jpg);">
								<div class="overlay"></div>
								<div class="text text-center">
									<h3>Paket 6</h3>
						...
						<div class="col-md-4 ftco-animate">
							<a href="{{ url('indexfoto/paket/photocolase')}}" class="photography-entry img  d-flex justify-content-center align-items-center" style="background-image: url(welcome/assets/images/image_7.jpg);">
								<div class="overlay"></div>
								<div class="text text-center">
									<h3>Paket 7</h3>
						...
						<div class="col-md-4 ftco-animate">
							<a href="/welcome/assets/images/image_8.jpg" class="photography-entry img image-popup d-flex justify-content-center align-items-center" style="background-image: url(welcome/assets/images/image_8.jpg);">
								<div class="overlay"></div>
								<div class="text text-center">
									<h3>Work 08</h3>
						...
						<div class="col-md-4 ftco-animate">
							<a href="/welcome/assets/images/image_9.jpg" class="photography-entry img image-popup d-flex justify-content-center align-items-center" style="background-image: url(welcome/assets/images/image_9.jpg);">
								<div class="overlay"></div>
								<div class="text text-center">
									<h3>Work 09</h3>
